<template>
    <div>
        ...
        <div class="mb-12">
            <picture
                style="height: 382px;"
                class="block shadow rounded-lg flex items-center justify-center mb-6 bg-sky-700"
            >
        ...
        <div class="mb-12">
            <picture
                style="height: 382px;"
                class="block shadow rounded-lg flex items-center justify-center mb-6 bg-lime-500"
            >
        ...
        <div>
            <picture
                style="height: 382px;"
                class="block shadow rounded-lg flex items-center justify-center mb-6 bg-orange-400"
            >
